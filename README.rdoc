...
An account may have one or more transactions, each of which may be matched or unmatched. When matched, a transactions will have a sender and recipient and belong to a group of two or more transactions. The sum of the total amounts in a group always equals to zero.
