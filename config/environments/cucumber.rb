...
config.gem 'database_cleaner', :lib => false, :version => '>=0.4.1' unless File.directory?(File.join(Rails.root, 'vendor/plugins/database_cleaner'))
...
config.gem 'pickle', :version => '>= 0.2.1'