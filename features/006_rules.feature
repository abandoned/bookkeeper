Feature: Rules
  ...
  Scenario: Set up a rule
    ...
    And I press "Submit"
    Then a rule should exist with matched_description: "Purchase", account: account "Bank A/C"
  ...
  Scenario: Rules matches ledger item by description
    ...
    And a ledger_item should exist with sender: contact "Self", recipient: contact "Other", total_amount: -20, account: account "Bank A/C"
