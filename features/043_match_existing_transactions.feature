Feature: Match Existing Ledger Items
  ...
  Scenario: Match three ledger items and reconcile
    Given a ledger_item "t1" exists with id: 10, total_amount: -4.00, asset: asset "Bank Account", sender: contact "Awesome Bakery", recipient: contact "Flour Corp"
    And a ledger_item "t2" exists with id: 11, total_amount: 2.00, expense: expense "Flour", sender: contact "Flour Corp", recipient: contact "Awesome Bakery"
    And a ledger_item "t3" exists with id: 12, total_amount: 2.00, expense: expense "Flour", sender: contact "Flour Corp", recipient: contact "Awesome Bakery"
    When I go to path "/transactions"
    And I press "Match" within "#ledger_item_10"
    And I press "Match" within "#ledger_item_11"
    And I press "Match" within "#ledger_item_12"
    And I follow "Save match"
