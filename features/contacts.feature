Feature: Manage Contacts
  ...
  Scenario: Create a contact
    ...
    And I should see "Vendor" within "#content h1"
  ...
  Scenario: Cannot delete a contact who is the sender of a ledger item
    Given a contact "Vendor" exists 
    And a ledger_item "Transaction" exists with sender: contact "Vendor"
    When I am on the show page for contact "Vendor"
    And I follow "Delete"
    Then I should see "Cannot delete contact because she has dependants"
    And contact "Vendor" should exist
  
  Scenario: Cannot delete a contact who is the recipient of a ledger item
    Given a contact "Vendor" exists
    Given a ledger_item "Transaction" exists with recipient: contact "Vendor"
    When I am on the show page for contact "Vendor"
    And I follow "Delete"
    Then I should see "Cannot delete contact because she has dependants"
    And contact "Vendor" should exist